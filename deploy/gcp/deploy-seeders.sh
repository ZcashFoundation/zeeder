...
# Container image, published by .github/workflows/release.yml (on GitHub release)
# to docker.io/zfnd/dnsseeder. In production prefer pinning by digest —
# IMAGE=docker.io/zfnd/dnsseeder@sha256:… — which is reproducible and
# cosign-verifiable; `latest` is a convenience default for ad-hoc rolls.
CONTAINER_IMAGE="${IMAGE:-docker.io/zfnd/dnsseeder:latest}"
